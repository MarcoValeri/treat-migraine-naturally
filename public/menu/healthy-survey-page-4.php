...
<!-- main --> 
<main class="healthy-main-page-four">
    <fieldset>
        <legend>Page 4 of 4</legend>

        <section class="healthy-main-page-four-error">
        ...
        <section class="healthy-main-page-four-title">
            <h2>Patient Details</h2>
        </section>

        <form class="healthy-main-page-four-form-gridcontainer" action="<?= $redirect_next; ?>" method="post">
            <section class="healthy-main-page-four-form-gridcontainer-title">
                <h4>Migraine History:</h4>
            </section>
            <section class="healthy-main-page-four-form-gridcontainer-migraine">
            ...
            <section class="healthy-main-page-four-form-gridcontainer-type">
            ...
            <section class="healthy-main-page-four-form-gridcontainer-duration">
            ...
            <section class="healthy-main-page-four-form-gridcontainer-stages">
            ...
            <section class="healthy-main-page-four-form-gridcontainer-symptoms">
            ...
            <section class="healthy-main-page-four-form-gridcontainer-medication">
            ...
            <section class="healthy-main-page-four-form-gridcontainer-effects">
                <label for="medication-side-effects">
                <strong>Medication side effects</strong>
                <p>Describe any side effects and adverse reactions you have had to the medications you have taken for migraine</p>
                </label>
                <textarea id="medication-side-effects" name="medication-side-effects" rows="4" cols="50"></textarea>
            </section>
            <section class="healthy-main-page-four-form-gridcontainer-non-medical">
            ...
            <section class="healthy-main-page-four-form-gridcontainer-triggers">
            ...
            <section class="healthy-main-page-four-form-gridcontainer-lifestyle">
            ...
            <section class="healthy-main-page-four-form-gridcontainer-tobacco">
                <h4>Tobacco</h4>
            ...
            <section class="healthy-main-page-four-form-gridcontainer-alcohol">
            ...
            <section class="healthy-main-page-four-form-gridcontainer-exercise">
            ...
            <section class="healthy-main-page-four-form-gridcontainer-fitness">
            ...
            <section class="healthy-main-page-four-form-gridcontainer-posture">
            ...
            <section class="healthy-main-page-four-form-gridcontainer-back">
                <button><a href="<?= url_for('/menu/healthy-survey-page-3.php'); ?>">Back</a></button>
            </section>
            <section class="healthy-main-page-four-form-gridcontainer-next">
